        ...
        <div className="bg-[#F5F5F5] border border-[#FF980E] rounded-[8px] p-5 flex flex-col gap-3 shadow-sm shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[14px] text-[#82828C] font-medium">Transcript</span>
            </div>
            <span className="text-[12px] text-[#82828C]">just now</span>
          </div>
          
          <p className={`text-[15px] text-[#5B5B66] leading-relaxed ${thinRegularClass}`}>
            I’ve updated the border-radius to 15 across the primary components to soften the design. I suggest we also increase the blur intensity on the cards.
          </p>

          <button className="self-end mt-1 flex items-center gap-1.5 px-4 py-1.5 bg-[#E9E9EB] hover:bg-[#DCDCE0] rounded-full text-[13px] font-medium text-[#5B5B66] transition-all active:scale-95">
            Confirm suggestion →
          </button>
        </div>

        {/* YOUR VOICE */}
        <div className="bg-[#F5F5F5] border border-[#CFCFCF] rounded-[8px] p-5 flex flex-col gap-3 shadow-sm shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <img src="/microphone_icon.webp" className="w-4 h-4 object-contain opacity-60" alt="Mic" />
          ...
          <p className={`text-[15px] text-[#5B5B66] leading-relaxed italic ${thinRegularClass}`}>
            "Let’s soften the UI on the first three frames to align with the client branding."
          </p>
        </div>
      </div>
